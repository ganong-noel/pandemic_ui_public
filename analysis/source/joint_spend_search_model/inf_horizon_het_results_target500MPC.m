display('Simulating Target Job Find Rate but MPC .25 Model Effects of $600')
...
mean_c_with_and_withoutFPUC_expect_target500MPC_2020=[mean_c_sim_pandemic_expect' mean_c_sim_pandemic_expect_noFPUC'];
save('mean_c_with_and_withoutFPUC_expect_target500MPC_2020.mat','mean_c_with_and_withoutFPUC_expect_target500MPC_2020')
...
stat_for_text=table();
stat_for_text.('mpc waiting target 500 mpc')=mpc.surprise('waiting');
stat_for_text_mpc_surprise_waiting = mpc.surprise('waiting');
save('stats_for_text_model_miscellaneous.mat', 'stat_for_text_mpc_surprise_waiting', '-append')
...
mean_c_sim_e_dollars_level=mean_c_sim_e*total_spend_e(1);
...
load prepandemic_results_target500MPC.mat
...
mpc_pandemic_match500mpc=mpc;
mpc_pandemic_match500mpc_betahigh=mpc_betahigh;
mpc_supplements_pandemic_match500mpc=mpc_supplements;
save('prepandemic_andpandemic_results_target500MPC','mean_c_sim_prepandemic_expect_dollars','mean_c_sim_prepandemic_expect_noFPUC_dollars','mpc_pandemic_match500mpc','mpc_pandemic_match500mpc_betahigh','mpc_prepandemic','mpc_supplements_prepandemic','mpc_supplements_pandemic_match500mpc','mean_search_sim_prepandemic_expect_noFPUC','mean_search_sim_prepandemic_expect','mean_c_sim_prepandemic_surprise_dollars','mean_c_sim_prepandemic_surprise_noFPUC_dollars','mean_search_sim_prepandemic_surprise','elasticity_and_distortions_values_prepandemic','mean_c_sim_pandemic_expect_dollars_match500MPC','mean_c_sim_pandemic_surprise_dollars_match500MPC','mean_search_sim_pandemic_expect_match500MPC','mean_search_sim_pandemic_surprise_match500MPC')
toc

a_init_target500MPC=mean_a_sim_pandemic_surprise_bywage(:,10);
a_init_pandemic_surprise_target500MPC_endofjuly=mean_a_sim_pandemic_surprise_bywage(:,8);
a_init_pandemic_surprise_noFPUC_target500MPC_endofjuly=mean_a_sim_pandemic_surprise_noFPUC_bywage(:,8);
a_init_e_target500MPC_endofjuly=mean_a_sim_e_bywage(:,8);
save('a_init_target500MPC','a_init_target500MPC','a_init_pandemic_surprise_target500MPC_endofjuly','a_init_pandemic_surprise_noFPUC_target500MPC_endofjuly','a_init_e_target500MPC_endofjuly');