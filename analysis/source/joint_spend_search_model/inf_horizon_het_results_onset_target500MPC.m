display('Simulating Target Job Find Rate but MPC .25 Model Effects of $300')
...
load bestfit_prepandemic
load bestfit_target500mpcs.mat
...
for iy=1:5
    ...
    %if surprise==1
        k=sse_surprise_fit_het_full_match500MPC(1);
        gamma=sse_surprise_fit_het_full_match500MPC(2);
        c_param=sse_surprise_fit_het_full_match500MPC(3);
    %else
    %    k=sse_expect_fit_het_full_match500MPC(1);
    %    gamma=sse_expect_fit_het_full_match500MPC(2);
    %    c_param=sse_expect_fit_het_full_match500MPC(3);
    %end
   ...
   benefit_profile_pandemic(1:10,3)=h+b;
    ...
    if use_initial_a==1
        ...
        initial_a_vec=a_init_target500MPC;
...
mean_c_with_and_withoutFPUC_expect_target500MPC_2021=[mean_c_sim_pandemic_expect' mean_c_sim_pandemic_expect_noFPUC'];
save('mean_c_with_and_withoutFPUC_expect_target500MPC_2021.mat','mean_c_with_and_withoutFPUC_expect_target500MPC_2021')
...
load prepandemic_results_onset_target500MPC.mat

mean_c_sim_pandemic_expect_dollars_match500MPC=mean_c_sim_pandemic_expect_dollars;
mean_c_sim_pandemic_surprise_dollars_match500MPC=mean_c_sim_pandemic_surprise_dollars;
mean_c_sim_pandemic_expect_jan_start_dollars_match500MPC=mean_c_sim_pandemic_expect_jan_start_dollars;

mean_search_sim_pandemic_expect_match500MPC=mean_search_sim_pandemic_expect;
mean_search_sim_pandemic_surprise_match500MPC=mean_search_sim_pandemic_surprise;
mean_search_sim_pandemic_expect_jan_start_match500MPC=mean_search_sim_pandemic_expect_jan_start;


mpc_supplements_onset_target500MPC = table();
mpc_supplements_onset_target500MPC.expect('one_month') = (mean_c_sim_pandemic_expect(3) - mean_c_sim_pandemic_expect_noFPUC(3)) / (mean_y_sim_pandemic_u(3) - mean_y_sim_pandemic_noFPUC(3));
mpc_supplements_onset_target500MPC.expect('3_month') = sum(mean_c_sim_pandemic_expect(3:5) - mean_c_sim_pandemic_expect_noFPUC(3:5)) / sum(mean_y_sim_pandemic_u(3:5) - mean_y_sim_pandemic_noFPUC(3:5));
mpc_supplements_onset_target500MPC.expect('6_month') = sum(mean_c_sim_pandemic_expect(3:8) - mean_c_sim_pandemic_expect_noFPUC(3:8)) / sum(mean_y_sim_pandemic_u(3:8) - mean_y_sim_pandemic_noFPUC(3:8));
mpc_supplements_onset_target500MPC.expect('full') = sum(mean_c_sim_pandemic_expect(3:10) - mean_c_sim_pandemic_expect_noFPUC(3:10)) / sum(mean_y_sim_pandemic_u(3:10) - mean_y_sim_pandemic_noFPUC(3:10));
mpc_supplements_onset_target500MPC.expect('full+3') = sum(mean_c_sim_pandemic_expect(3:13) - mean_c_sim_pandemic_expect_noFPUC(3:13)) / sum(mean_y_sim_pandemic_u(3:13) - mean_y_sim_pandemic_noFPUC(3:13));
mpc_supplements_onset_target500MPC.Variables=scale_factor*mpc_supplements_onset_target500MPC.Variables

save('prepandemic_andpandemic_results_onset_target500MPC','mpc_supplements_onset_target500MPC','mean_c_sim_prepandemic_expect_dollars','mean_c_sim_prepandemic_expect_noFPUC_dollars','mean_search_sim_prepandemic_expect','mean_c_sim_prepandemic_surprise_dollars','mean_c_sim_prepandemic_surprise_noFPUC_dollars','mean_search_sim_prepandemic_surprise','elasticity_and_distortions_values_prepandemic_onset','mean_c_sim_pandemic_expect_dollars_match500MPC','mean_c_sim_pandemic_surprise_dollars_match500MPC','mean_search_sim_pandemic_expect_match500MPC','mean_search_sim_pandemic_surprise_match500MPC', 'mean_c_sim_pandemic_expect_jan_start_dollars_match500MPC', 'mean_search_sim_pandemic_expect_jan_start_match500MPC')
