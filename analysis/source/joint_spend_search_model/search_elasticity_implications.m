...
function search_elasticity = search_elasticity_implications(pars, infinite_dur, include_recalls)
    ...
    for iy = 1:5
        ...
        for t = 1:15
            ...
            for i = 1:num_unemployed_hh
                ...
                % Based on time the consumption is different
                %if t == 1
                %    c_pol_e = c_pol_e_betahigh;
                %    c_pol_u = c_pol_u_betahigh;
                %    c_pol_u_augmented = c_pol_u_augmented_betahigh;
                %    beta=beta_high;
                %else
    ...
    search_elasticity=(mean(mean_search_sim_augmented(1:6))/mean(mean_search_sim_regular(1:6))-1)/perc_change_benefits;
