...
for iy = 1:5
    ...
    for surprise = 0:1
        ...
        benefit_profile_pandemic(2:12, 5) = h + b;
...
% get relevant series and save to Matlab object to be used in graph in
% script `inf_horizon_het_results_timeaggregation.m`:
spend_model_lagged_surprise_target500MPC = mean_c_sim_pandemic_surprise_dollars(2:12)/total_spend_u(1)*100;
spend_model_lagged_expect_target500MPC = mean_c_sim_pandemic_expect_dollars(2:12)/total_spend_u(1)*100;
save('timeaggregation_target500MPC.mat', 'spend_model_lagged_surprise_target500MPC', 'spend_model_lagged_expect_target500MPC');
