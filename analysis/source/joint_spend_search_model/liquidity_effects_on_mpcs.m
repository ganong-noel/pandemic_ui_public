...
stat_for_text_change_checking_u_vs_e_liquidity_effect_mpc=(checking_u(7)-checking_u(3))-(checking_e(7)-checking_e(3))
save('stats_for_text_model_miscellaneous.mat', 'stat_for_text_change_checking_u_vs_e_liquidity_effect_mpc', '-append')
...
load a_init_bestfit
load a_init_target500mpc
        if calibration==1
            tmp_a = a_sim(:, burnin + 1);
        elseif calibration==2
            tmp_a=ones(numhh,1)*a_init_pandemic_surprise_target500MPC_endofjuly(iy);
        elseif calibration==3
            tmp_a=ones(numhh,1)*a_init_e_target500MPC_endofjuly(iy);
        end
...
if calibration==1
    mpc_baseline=mpc;
    mpc_supplements_baseline=mpc_supplements;
elseif calibration==2
    mpc_u_pandemic=mpc;
    mpc_supplements_u_pandemic=mpc_supplements;
elseif calibration==3
    mpc_e_pandemic=mpc;
    mpc_supplements_e_pandemic=mpc_supplements;
end

end

if betaloop==1
    mpc_results_beta500=table();
    mpc_results_beta500.aug_liquidity('500 quarterly-unemployed')=mpc_u_pandemic.surprise('500 quarterly-unemployed');
    mpc_results_beta500.normal_liquidity('500 quarterly-unemployed')=mpc_baseline.surprise('500 quarterly-unemployed');
    mpc_results_beta500.aug_liquidity('500 quarterly-employed')=mpc_u_pandemic.surprise('500 quarterly-employed');
    mpc_results_beta500.normal_liquidity('500 quarterly-employed')=mpc_baseline.surprise('500 quarterly-employed')

    mpc_baseline_beta500=mpc_baseline;
else
    mpc_results_betawaiting=table();
    mpc_results_betawaiting.aug_liquidity('500 quarterly-unemployed')=mpc_u_pandemic.surprise('500 quarterly-unemployed');
    mpc_results_betawaiting.normal_liquidity('500 quarterly-unemployed')=mpc_baseline.surprise('500 quarterly-unemployed');
    mpc_results_betawaiting.aug_liquidity('500 quarterly-employed')=mpc_u_pandemic.surprise('500 quarterly-employed');
    mpc_results_betawaiting.normal_liquidity('500 quarterly-employed')=mpc_baseline.surprise('500 quarterly-employed')
end
...
mpc_results_for_paper=table();
mpc_results_for_paper.aug_liquidity('500 quarterly-unemployed, no beta heterogeneity')=mpc_results_beta500.aug_liquidity('500 quarterly-unemployed');
mpc_results_for_paper.normal_liquidity('500 quarterly-unemployed, no beta heterogeneity')=mpc_results_beta500.normal_liquidity('500 quarterly-unemployed');
mpc_results_for_paper.aug_liquidity('500 quarterly-unemployed, with beta heterogeneity')=mpc_results_betawaiting.aug_liquidity('500 quarterly-unemployed');
mpc_results_for_paper.normal_liquidity('500 quarterly-unemployed, with beta heterogeneity')=mpc_results_betawaiting.normal_liquidity('500 quarterly-unemployed');
mpc_results_for_paper.aug_liquidity('500 quarterly-employed')=mpc_results_beta500.aug_liquidity('500 quarterly-employed');
mpc_results_for_paper.normal_liquidity('500 quarterly-employed')=mpc_results_beta500.normal_liquidity('500 quarterly-employed')

diff_no=mpc_results_for_paper.normal_liquidity('500 quarterly-unemployed, no beta heterogeneity')-mpc_results_for_paper.normal_liquidity('500 quarterly-employed')

ushare=(mpc_baseline_beta500.surprise('500 quarterly')-mpc_baseline_beta500.surprise('500 quarterly-employed'))/(mpc_baseline_beta500.surprise('500 quarterly-unemployed')-mpc_baseline_beta500.surprise('500 quarterly-employed'));


mpc_eimplied=(mpc_baseline_beta500.surprise('500 quarterly')-(mpc_results_betawaiting.normal_liquidity('500 quarterly-unemployed'))*ushare)/(1-ushare);

diff_with=mpc_results_for_paper.normal_liquidity('500 quarterly-unemployed, with beta heterogeneity')-mpc_eimplied

(diff_with-diff_no)/diff_with