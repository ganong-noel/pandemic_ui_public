...
for FPUC_mult_index=1:length(FPUC_mult)    
    ...
    stat_for_text_change_checking_u_vs_e_stimulus=(checking_u(7)-checking_u(3))-(checking_e(7)-checking_e(3))
    save('stats_for_text_model_miscellaneous.mat', 'stat_for_text_change_checking_u_vs_e_stimulus', '-append')
    ...
    for iy = 1:5
        ...
        for surprise = 0:1
           ...
           benefit_profile_pandemic(5:12, 8) = b + h;
            ...
            mpc_500_u_by_t = (mean_c_sim_u_with_500 - mean_c_sim_u_without_500) / (shock_FPUC_multsize);
            ...
            if FPUC_mult_index>1
                mpc_lastdollars_by_t = (mean_c_sim_with_500 - mean_c_sim_smaller_bywage(iy, :)) / (FPUCsize*1/12);
                mpc_lastdollars_u_by_t = (mean_c_sim_u_with_500 - mean_c_sim_u_smaller_bywage(iy, :)) / (FPUCsize*1/12);
            else
                mpc_lastdollars_by_t=(mean_c_sim_with_500 - mean_c_sim) / (FPUCsize*1/12);
                mpc_lastdollars_u_by_t=(mean_c_sim_u_with_500 - mean_c_sim_u_without_500) / (FPUCsize*1/12);
            end
            for t = 1:numsim
                mpc_lastdollars_cum_dynamic(t) = sum(mpc_lastdollars_by_t(1:t));
                mpc_lastdollars_u_cum_dynamic(t) = sum(mpc_lastdollars_u_by_t(1:t));
            end
            if surprise == 0
                mpc_expect_lastdollars_bywage(iy, :) = mpc_lastdollars_cum_dynamic(:);
                mpc_expect_lastdollars_u_bywage(iy, :) = mpc_lastdollars_u_cum_dynamic(:);
            end
    
            
            mean_c_sim_smaller_bywage(iy, :)=mean_c_sim_with_500;
            mean_c_sim_u_smaller_bywage(iy, :)=mean_c_sim_u_with_500;
    ...
    mpc_expect_500_e_6month = mean(mpc_expect_500_e_bywage(:, 6));
    
    mpc_expect_500_u_6month = mean(mpc_expect_500_u_bywage(:, 6));
    ...
    mpc_expect_lastdollars_u_6month = mean(mpc_expect_lastdollars_u_bywage(:, 6));
    mpc_expect_lastdollars_u_quarterly = mean(mpc_expect_lastdollars_u_bywage(:, 3));
    mpc_expect_lastdollars_u_monthly = mean(mpc_expect_lastdollars_u_bywage(:, 1));
    ...
    mpc.expected('500 6 month-employed') = mpc_expect_500_e_6month;
    mpc.expected('500 6 month-unemployed') = mpc_expect_500_u_6month;
    ...
    mpc.expected('Last Dollars 6 month-unemployed') = mpc_expect_lastdollars_u_6month;
    mpc.expected('Last Dollars quarterly-unemployed') = mpc_expect_lastdollars_u_quarterly;
    mpc.expected('Last Dollars monthly-unemployed') = mpc_expect_lastdollars_u_monthly;
    ...
    mpc_by_size_u(FPUC_mult_index)=mpc.expected('500 monthly-unemployed');
    mpc_marginal_by_size_u(FPUC_mult_index)=mpc.expected('Last Dollars monthly-unemployed');
    
    mpc_by_size_quarterly_u(FPUC_mult_index)=mpc.expected('500 quarterly-unemployed');
    mpc_marginal_by_size_quarterly_u(FPUC_mult_index)=mpc.expected('Last Dollars quarterly-unemployed');
    
    mpc_by_size_6month_u(FPUC_mult_index)=mpc.expected('500 6 month-unemployed');
    mpc_marginal_by_size_6month_u(FPUC_mult_index)=mpc.expected('Last Dollars 6 month-unemployed');
...
if beta_normal_loop==1
    duration_increase_total_beta_target500MPC=squeeze(elasticity_and_distortions_values_by_size(8,1:end))-baseline_duration;
    duration_increase_marginal_beta_target500MPC=squeeze(elasticity_and_distortions_values_by_size(8,2:end))-squeeze(elasticity_and_distortions_values_by_size(8,1:end-1));
    duration_increase_marginal_beta_target500MPC=[duration_increase_total_beta_target500MPC(1) duration_increase_marginal_beta_target500MPC];
    ...
    mpc_by_size_beta_targetwaiting_6month_u=mpc_by_size_6month_u;
    mpc_marginal_by_size_beta_targetwaiting_6month_u=mpc_marginal_by_size_6month_u;
    
    mpc_by_size_beta_targetwaiting_quarterly_u=mpc_by_size_quarterly_u;
    mpc_marginal_by_size_beta_targetwaiting_quarterly_u=mpc_marginal_by_size_quarterly_u;
    
    mpc_by_size_beta_targetwaiting_u=mpc_by_size_u;
    mpc_marginal_by_size_beta_targetwaiting_u=mpc_marginal_by_size_u;
end

end

duration_increase_total_stimcheck=duration_increase_total_beta_targetwaiting;
duration_increase_marginal_stimcheck=duration_increase_marginal_beta_targetwaiting;

quarterly_mpc_without_e_het=.08*mpc_by_size_beta_targetwaiting_quarterly+.92*mpc_by_size_beta_target500MPC_quarterly;
stim_500_without_e_het=mean(quarterly_mpc_without_e_het(2:3));
prop_adj=.25/stim_500_without_e_het;

mpc_by_size_stimcheck=.08*mpc_by_size_beta_targetwaiting+.92*mpc_by_size_beta_target500MPC*prop_adj;
mpc_marginal_by_size_stimcheck=.08*mpc_marginal_by_size_beta_targetwaiting+.92*mpc_marginal_by_size_beta_target500MPC*prop_adj;

mpc_by_size_stimcheck_quarterly=.08*mpc_by_size_beta_targetwaiting_quarterly+.92*mpc_by_size_beta_target500MPC_quarterly*prop_adj;
mpc_marginal_by_size_stimcheck_quarterly=.08*mpc_marginal_by_size_beta_targetwaiting_quarterly+.92*mpc_marginal_by_size_beta_target500MPC_quarterly*prop_adj;

mpc_by_size_stimcheck_6month=.08*mpc_by_size_beta_targetwaiting_6month+.92*mpc_by_size_beta_target500MPC_6month*prop_adj;
mpc_marginal_by_size_stimcheck_6month=.08*mpc_marginal_by_size_beta_targetwaiting_6month+.92*mpc_marginal_by_size_beta_target500MPC_6month*prop_adj;



mpc_by_size_1monthsupp=mpc_by_size_beta_targetwaiting_u;
mpc_marginal_by_size_1monthsupp=mpc_marginal_by_size_beta_targetwaiting_u;

mpc_by_size_1monthsupp_quarterly=mpc_by_size_beta_targetwaiting_quarterly_u;
mpc_marginal_by_size_1monthsupp_quarterly=mpc_marginal_by_size_beta_targetwaiting_quarterly_u;

mpc_by_size_1monthsupp_6month=mpc_by_size_beta_targetwaiting_6month_u;
mpc_marginal_by_size_1monthsupp_6month=mpc_marginal_by_size_beta_targetwaiting_6month_u;


save('stimulus_check_size_results.mat','mpc_by_size_stimcheck','mpc_marginal_by_size_stimcheck','mpc_by_size_stimcheck_6month','mpc_marginal_by_size_stimcheck_6month','mpc_by_size_stimcheck_quarterly','mpc_marginal_by_size_stimcheck_quarterly','duration_increase_total_stimcheck','duration_increase_marginal_stimcheck','mpc_by_size_1monthsupp','mpc_marginal_by_size_1monthsupp','mpc_by_size_1monthsupp_6month','mpc_marginal_by_size_1monthsupp_6month','mpc_by_size_1monthsupp_quarterly','mpc_marginal_by_size_1monthsupp_quarterly')